...
public static void main(String [] args){
  ...
  while(playAgain) {
      while (!gameOver) {
          System.out.println(" ");
          System.out.println("Thanks for choosing Java Tic tac Toe!");
...
public static void playerMove(char[][] gameBoard){
    ...
    while(!result){
        System.out.println("That Box is alredy taken, please pick another :( ");
        move = input.nextInt();
        result = isValidMove(move,gameBoard);
    }

    System.out.println("You moved at position " + move);
...
public static boolean isValidMove(int move, char[][] gameboard){
  ...
  public static void computerMove(char [][] gameBoard){
    ...
    // how the computer picks a spot on the board
